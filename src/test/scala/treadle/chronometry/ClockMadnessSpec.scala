...
class ClockMadnessSpec extends FreeSpec with Matchers {
  val input =
    """
      ...
      |      reset => (UInt<1>("h0"), counter) @[ClockMadnessSpec.scala 13:24:@8.4]
      |    node _T_6 = add(counter, UInt<1>("h1")) @[ClockMadnessSpec.scala 15:22:@9.4]
      |    node _T_7 = tail(_T_6, 1) @[ClockMadnessSpec.scala 15:22:@10.4]
      |    io_count <= counter
      ...
      |
      |    node _T_4 = asUInt(clock) @[ClockMadnessSpec.scala 26:29:@19.4]
      |    node _T_5 = bits(_T_4, 0, 0) @[ClockMadnessSpec.scala 26:31:@20.4]
      |    node _T_6 = and(_T_5, io_enable) @[ClockMadnessSpec.scala 26:35:@21.4]
      |    node clock2 = asClock(_T_6) @[ClockMadnessSpec.scala 26:55:@22.4]
      |    inst GatedCounter of GatedCounter @[ClockMadnessSpec.scala 29:31:@23.4]
